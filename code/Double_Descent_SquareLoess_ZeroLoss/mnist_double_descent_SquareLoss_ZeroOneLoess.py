...
fig = plt.figure()
ax = plt.subplot(111)
plt.plot([n_params[model_name] for model_name in model_names], [train_losses[model_name] for model_name in model_names], marker='o', label='train', color='#ff7f00')
...
fig = plt.figure()
ax = plt.subplot(111)
plt.plot([n_params[model_name] for model_name in model_names], [train_accs[model_name] for model_name in model_names], marker='o', label='train', color='#ff7f00')
...
# Zero-One Loss 
train_zero_one_losses = {model_name: 1 - train_accs[model_name] / 100 for model_name in model_names}
test_zero_one_losses = {model_name: 1 - test_accs[model_name] / 100 for model_name in model_names}

# Plot Zero-One Loss curves for training and testing
plt.plot([n_params[model_name] for model_name in model_names],
         [train_zero_one_losses[model_name] for model_name in model_names],
         marker='o', label='train', color='#ff7f00')  # Yellow line
plt.plot([n_params[model_name] for model_name in model_names],
         [test_zero_one_losses[model_name] for model_name in model_names],
         marker='o', label='test', color='#1f78b4')  # Blue line
...
if args.reuse:
    plt.savefig('MNIST_double_descent_zero_one_loss_w_weight_reuse.png')
else:
    plt.savefig('MNIST_double_descent_zero_one_loss_wo_weight_reuse.png')
